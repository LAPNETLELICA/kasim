...
import '../widgets/create_exam_session_dialog.dart';
...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  void _showCreateSessionWizard() {
    showDialog(
      ...
      builder: (context) => CreateExamSessionDialog(
            ...
            child: Row(
              children: [
                ...
                IconButton(
                  ...
                  icon: const Icon(Icons.manage_accounts_outlined, color: AppTheme.textMuted, size: 18),
                  onPressed: () async {
                    ...
                    if (updated == true && mounted) {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(content: Text('Profile updated. The new password can be used on your next sign-in.')),
                      );
                    }
                  },
                ),
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    const SizedBox(width: 5),
                    Text(
                      "Access: ${exam.allowedBrowser}${exam.allowedAi != null ? ' + ${exam.allowedAi}' : ''}",
