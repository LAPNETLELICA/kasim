...
class TestMasterAuthorizationEngine(unittest.TestCase):
    ...
    def test_five_product_modes_have_distinct_enforcement(self):
        base = {
            "default_action": "DENY",
            "desktop_app_mode": "BLOCK_ALL_UNAUTHORIZED",
            "registered_browsers": self.registered_browsers,
        ...
        # 1. Specific browser: Chrome is required, all web destinations pass.
        specific_browser = {
            **base,
            "policy_mode": "SPECIFIC_BROWSER",
            "browser_mode": "ALLOW_SELECTED",
            "ai_mode": "ALLOW_ANY",
            "web_access_scope": "ANY_SITE",
            "allowed_browsers": ["brw_chrome"],
            "allowed_ai": [],
            "browser_ai_matrix": {"brw_chrome": ["*"]},
        }
        self.assertEqual(evaluate_request(specific_browser, "chrome.exe", "chatgpt.com")[0], "ALLOW")
        self.assertEqual(evaluate_request(specific_browser, "firefox.exe", "chatgpt.com")[0], "DENY")

        # 2. Specific AI: any browser may open Claude, but not ordinary websites.
        specific_ai = {
            **base,
            "policy_mode": "SPECIFIC_AI",
            "browser_mode": "ALLOW_ANY",
            "ai_mode": "ALLOW_SELECTED",
            "web_access_scope": "AI_ONLY",
            "allowed_browsers": [],
            "allowed_ai": ["ai_claude"],
            "browser_ai_matrix": {"*": ["ai_claude"]},
        }
        self.assertEqual(evaluate_request(specific_ai, "vivaldi.exe", "claude.ai")[0], "ALLOW")
        self.assertEqual(evaluate_request(specific_ai, "vivaldi.exe", "wikipedia.org")[0], "DENY")
        self.assertEqual(evaluate_request(specific_ai, "vivaldi.exe", "chatgpt.com")[0], "DENY")

        # 3. Specific browser without AI.
        browser_no_ai = {
            **base,
            "policy_mode": "SPECIFIC_BROWSER_NO_AI",
            "browser_mode": "ALLOW_SELECTED",
            "ai_mode": "BLOCK_ALL",
            "web_access_scope": "ANY_SITE",
            "allowed_browsers": ["brw_chrome"],
        ...
        self.assertEqual(evaluate_request(browser_no_ai, "chrome.exe", "wikipedia.org")[0], "ALLOW")
        self.assertEqual(evaluate_request(browser_no_ai, "chrome.exe", "claude.ai")[0], "DENY")

        # 4. Any browser without AI.
        any_browser_no_ai = {
            **browser_no_ai,
            "policy_mode": "ANY_BROWSER_NO_AI",
            "browser_mode": "ALLOW_ANY",
            "allowed_browsers": [],
            "browser_ai_matrix": {},
        }
        self.assertEqual(evaluate_request(any_browser_no_ai, "brandnewbrowser.exe", "wikipedia.org")[0], "ALLOW")
        self.assertEqual(evaluate_request(any_browser_no_ai, "brandnewbrowser.exe", "claude.ai")[0], "DENY")

        # 5. Specific browser plus one AI.
        browser_and_ai = {
            **base,
            "policy_mode": "SPECIFIC_BROWSER_AND_AI",
            "browser_mode": "ALLOW_SELECTED",
            "ai_mode": "ALLOW_SELECTED",
            "web_access_scope": "ANY_SITE",
            "allowed_browsers": ["brw_chrome"],
        ...
        self.assertEqual(evaluate_request(browser_and_ai, "chrome.exe", "claude.ai")[0], "ALLOW")
        self.assertEqual(evaluate_request(browser_and_ai, "chrome.exe", "chatgpt.com")[0], "DENY")
